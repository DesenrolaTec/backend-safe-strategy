...
class ConnectionRepository(ConnectionRepositoryInterface):
    ...
    def create(self, user_id: int, organization_id: int, role: str, enable: int):
        profile = Profile(user_id=user_id, organization_id=organization_id, role=role, enable=enable)
