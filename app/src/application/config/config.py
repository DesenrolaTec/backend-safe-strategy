...
class Config:
    ...
    def __init__(self, environment: str = "prod"):
        ...
        if not hasattr(self, '_initialized'):
            ...
            self.OAUTH2_REFRESH_TOKEN_GENERATOR = eval(os.getenv('OAUTH2_REFRESH_TOKEN_GENERATOR'))
            self.SQLALCHEMY_TRACK_MODIFICATIONS = eval(os.getenv('SQLALCHEMY_TRACK_MODIFICATIONS'))
            ...
            self.OAUTHLIB_INSECURE_TRANSPORT = eval(os.getenv('OAUTHLIB_INSECURE_TRANSPORT'))
