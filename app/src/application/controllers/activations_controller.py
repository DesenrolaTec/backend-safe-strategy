...
class ActivationsController(ActivationsControllerInterface):
    def __init__(self,
                 ...
                 delete_activations_usecase: DeleteActivationsUsecase):
        ...
        self.delete_activations_usecase = delete_activations_usecase
    ...
    def delete_activations(self, activation_id):
        try:
            response = self.delete_activations_usecase.execute(activation_id)
            return response
        except Exception as e:
            raise e
